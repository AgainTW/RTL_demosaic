from hw5_utils import path_set, read_img, img_show_gray, psnr
...
if __name__=='__main__':
	...
	img2 = cv2.imread("C:/AG/course notes/111_2/IC design/HW5/HW5/file/golden/test1.png")
	print(psnr(RGB, img2))
	print(psnr(RGB[2:126,2:126], img2[2:126,2:126]))